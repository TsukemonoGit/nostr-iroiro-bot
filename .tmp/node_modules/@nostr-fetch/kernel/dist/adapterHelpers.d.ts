...
import { type FetchTillEoseOptions } from "./fetcherBackend";
 ...
 * ```
 */
export declare const setupSubscriptionAutoAbortion: (closeSub: () => void, tx: ChannelSender<NostrEvent>, options: FetchTillEoseOptions) => (() => void);
//# sourceMappingURL=adapterHelpers.d.ts.map